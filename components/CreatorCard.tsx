...
const CreatorCard = ({ key, rank, creatorImage, creatorName, creatorEths }: CreatorCardProps) => (
  <div key={key} className="min-w-190 minlg:min-w-240 dark:bg-nft-black-3 bg-white border dark:border-nft-black-3 border-nft-gray-1 rounded-3xl flex flex-col p-4 m-4">
